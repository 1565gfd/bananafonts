...
(function () {
  ...
  var TEXT = {
    ru: {
      ...
      settingsAboutText: "Banana — помогающий сайт.\n\n• Главная: счётчик символов/слов/строк, преобразование регистра, сортировка и очистка строк, реверс, копирование.\n\n• Шрифты: визуальная сетка шрифтов — системные для Word, Google Fonts, Unicode-стили для Telegram/Discord, подчёркнутый/зачёркнутый, поиск.\n\n• Калькулятор: базовый с процентами и preview-строкой выражения, геометрия, перевод единиц, сложение/вычитание/умножение/деление дробей.\n\n• Время: часы Москвы / Еревана / Нью-Йорка, секундомер, таймер с миллисекундами и быстрым ± времени, будильник с выбором часового пояса.\n\n• Инструменты: 17 утилит — UUID, Base64, HEX, ROT13, Morse, slug, camelCase, snake_case, kebab-case, strip HTML, sponge case, Pretty JSON, sort/unique lines, и др.\n\n• Кастом: 19 живых ручек настройки UI — масштаб, glass-blur, скругление, скорость анимаций, насыщенность, толщина шрифта, межбукв, межстрок, яркость, оттенок, контраст, сепия, инверсия, прозрачность стекла, толщина границ, глубина теней, виньетка, отступ страницы, Z-высота карточек + компактный режим.\n\n• Настройки: extra-темы, переключатель звуков (52 типа), генератор паролей, случайные числа, Lorem Ipsum (RU/lat), конвертер цветов (HEX/RGB/HSL).\n\n• Аккаунты: регистрация e-mail + код-подтверждение, SHA-256 + salt для паролей, аватарка-эмодзи или картинка (canvas-compress 128×128 JPEG), цветовая палитра, биография, профиль с историей визитов, мульти-аккаунт-менеджер.\n\n• Темы: 68 штук — 5 базовых + 13 экстра + 50 новых по 7 категориям (природа, космос, настроения, культура, еда, тех, камни).\n\n• Секретные коды: вкладка с 20 публичными кодами — emoji-дожди, спецэффекты, мета-код, +1 секретная тема (BANANAKING). Найди их сам.\n\n• Безопасность: 120+ паттернов анти-мат фильтра + leet-speak normalizer (RU/EN + 10 языков), red lockout с apology-экраном.\n\n• Полная мобильная адаптация: 17 типов экранов от смарт-часов (≤280px) до 8K-телевизоров (≥3200px), поддержка e-Ink, forced-colors, foldable, portrait monitors.\n\n• Cross-browser: Chrome / Firefox / Safari / Edge / Opera / Brave / Vivaldi / Yandex / Samsung Internet / Tor + fallback для Lynx, w3m, Browsh через <noscript>, баннер для устаревших браузеров.\n\n• PWA: можно установить на телефон/десктоп, работает в Telegram-браузере."
    },
    en: {
      ...
      settingsAboutText: "Banana — a helper site.\n\n• Home: character/word/line counter, case conversion, line sort and cleanup, reverse, copy.\n\n• Fonts: visual font grid — Word-safe, Google Fonts, Unicode for Telegram/Discord, underline/strikethrough, search.\n\n• Calculator: basic with percentages and a preview line of the expression, geometry, unit conversion, fraction arithmetic.\n\n• Time: clocks for Moscow / Yerevan / New York, stopwatch, timer with milliseconds and quick ±time, alarm with timezone picker.\n\n• Tools: 17 utilities — UUID, Base64, HEX, ROT13, Morse, slug, camelCase, snake_case, kebab-case, strip HTML, sponge case, Pretty JSON, sort/unique lines, and more.\n\n• Custom: 19 live UI knobs — scale, glass-blur, radius, animation speed, saturation, font weight, letter/line spacing, brightness, hue, contrast, sepia, invert, glass transparency, border width, shadow depth, vignette, page padding, card Z-height + compact mode toggle.\n\n• Settings: extra themes, sound toggle (52 types), password generator, random numbers, Lorem Ipsum (RU/lat), color converter (HEX/RGB/HSL).\n\n• Accounts: registration with e-mail + verification code, SHA-256 + salt for passwords, emoji avatar or image (canvas-compressed 128×128 JPEG), color palette, bio, profile with visit history, multi-account manager.\n\n• Themes: 68 — 5 base + 13 extras + 50 new across 7 categories (nature, cosmic, mood, culture, food, tech, gems).\n\n• Secret codes: a tab with 20 public codes — emoji rains, special effects, a meta-code, +1 secret theme (BANANAKING). Find them yourself.\n\n• Safety: 120+ anti-profanity patterns + leet-speak normalizer (RU/EN + 10 languages), red lockout with apology screen.\n\n• Full mobile support: 17 screen-type breakpoints from smartwatches (≤280px) to 8K TVs (≥3200px), e-Ink / forced-colors / foldable / portrait monitor handling.\n\n• Cross-browser: Chrome / Firefox / Safari / Edge / Opera / Brave / Vivaldi / Yandex / Samsung Internet / Tor + fallback for Lynx, w3m, Browsh via <noscript>, legacy-browser banner.\n\n• PWA: installable on phone/desktop, works inside the Telegram in-app browser."
    }
  };
